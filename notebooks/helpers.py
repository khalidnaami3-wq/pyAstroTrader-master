...
from pyastrotrader import get_degrees, get_degree, calculate_chart, calculate_transits, calculate_aspects
...
def generate_charts(current_date, asset_natal_chart):
