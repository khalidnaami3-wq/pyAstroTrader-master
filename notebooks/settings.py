...
NATAL_DATES = {
    ...
    'AAPL' : '1980-12-12T09:30:00-05:00'
}
...
NPARTITIONS = 1 # multiprocessing.cpu_count() * 2
...
NATAL_DATE = NATAL_DATES.get(ASSET_TO_CALCULATE, '1980-12-12T09:30:00-05:00') # Default to AAPL date if missing
...
NUM_TREES = 1000
MAX_INTERACTIONS = 50
if os.environ.get('MODEL') == 'SWING_TRADE':
